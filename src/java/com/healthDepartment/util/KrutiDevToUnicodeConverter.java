 ...
 * @author jpss
 */
public class KrutiDevToUnicodeConverter {

    public String convert_to_unicode(String krutiString){
        if(krutiString == null)
            return "";
        String legacy_text = krutiString;
        ...
        //...String modified_substring = legacy_text;//document.getElementById("legacy_text").value  ;............................
        //****************************************************************************************
        //  Break the long text into small bunches of max. max_text_size  characters each.
        //****************************************************************************************
        
        int text_size = legacy_text.length();//document.getElementById("legacy_text").value.length ;
        ...
        while ( chale_chalo == 1 ){
            ...
            if ( sthiti2 < ( text_size - max_text_size ) ){
                ...
                while (legacy_text.charAt( sthiti2 ) != ' '){ //document.getElementById("legacy_text").value. ......................
                    sthiti2--;
                }
            } else  {
                sthiti2 = text_size  ;
            ...
            String modified_substring = legacy_text.substring ( sthiti1, sthiti2 );//document.getElementById("legacy_text").value.substring ( sthiti1, sthiti2 )  ;
            ...
            return processed_text;//document.getElementById("unicode_text").value = processed_text  ;..............
        }
    ...
    public  String Replace_Symbols( String[] array_one, String[] array_two, String modified_substring, int array_one_length ){
        ...
        if ( !modified_substring.isEmpty() )  // if stringto be converted is non-blank then no need of any processing.
        {
            ...
            while ( position_of_i != -1 )  //while-02
            {
                ...
                position_of_i = modified_substring.indexOf( "f" , position_of_i + 1 ); // search for i ahead of the current position. ...........search.............
            ...
            while ( position_of_i != -1 )  //while-02
            {
                ...
                position_of_i = modified_substring.indexOf( "fa" , position_of_i + 2 ); // search for i ahead of the current position. ...........search()...........
            ...
            //**********************************************************************************
            //Pattern ptrn = Pattern.compile("/Ê/");
            modified_substring = modified_substring.replace( "Ê" , "ीZ" ) ; // at some places  Ê  is  used eg  in "किंकर".
                ...
                
            {
                ...
                position_of_wrong_ee = modified_substring.indexOf( "ि्" , position_of_wrong_ee + 2 ); // search for 'wrong ee' ahead of the current position. .........search...........
            ...
            while ( position_of_R > 0 )  // while-04
            {
                ...
                while ( set_of_matras.contains( charecter_at_probable_position_of_half_r + "" ) )//!= null )  // while-05 ................
                ...
                String charecter_to_be_replaced = modified_substring.substring( probable_position_of_half_r , ( position_of_R) ) ;//................( position_of_R - probable_position_of_half_r ).....
                //charecter_to_be_replaced = modified_substring.substring( probable_position_of_half_r , 2 ) ;
...
/*public String Convert_to_Kritidev_010(){
...
//****************************************************************************************
   ...
   //************************************************************
    ...
    Replace_Symbols(array_one, array_two, modified_substring, array_one_length ) ;
