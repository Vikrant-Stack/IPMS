<%-- 
    Document   : newInterpolationPage
    Created on : Jan 23, 2019, 12:35:24 PM
    Author     : jpss
--%>
...
<script type="text/javascript">
	var map, osmLayer;
	var url_map = "http://localhost:8090/iserver/services/map-test_ws/rest/maps/test1";
	var url_spatial = "http://localhost:8090/iserver/services/spatialAnalysis-test_ws/restjsr/spatialanalyst";
	function init(){
	...
	function addLayer(){
	    ...
	    map.setCenter(new SuperMap.LonLat(8117599.6602827 , 2575048.539285), 16);
	}
	function transform(){
...
//      });
	...
	function themeCompleted(themeEventArgs) {
        if (themeEventArgs.result.resourceInfo.id) {
            themeLayer = new SuperMap.Layer.TiledDynamicRESTLayer("插值分析结果图", url_map, {
                cacheEnabled: true,
                transparent: true,
