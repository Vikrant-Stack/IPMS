                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="container">
                                                    ...
                                                    <form name="form1" class="form-group row" method="POST" action="organisationSubTypeCont.do">
...
<td>    <input class="btn btn-info" type="button" id="viewXls" name="viewXls" value="Excel" onclick="displayOrgSubTypeList(id);"/>
                            ...
                            <tr>
                                <td align="center">
                                    <DIV class="container">
                                        <form name="form2" method="POST" class="form-group row" action="organisationSubTypeCont.do" onsubmit="return verify()">
